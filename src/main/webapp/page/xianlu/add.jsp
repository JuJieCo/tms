...
<body>
	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			...
			<form name="form" method="post" action="${pageContext.request.contextPath}/xianluAction!modifyXianlu" onsubmit="return validateForm(this)">
				...
				<div style="width: 1200px; margin: auto">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td>
								<input type="text" id="name" name="xianlu.name" value="${xianlu.name}" class="span2" /> 
								<input name="xianlu.xlid" type="hidden" value="${xianlu.xlid }">
							</td>
							<td width="10%" align="right" bgcolor="#f1f1f1">线路状态：</td>
							<td>
								<select name="xianlu.state" class="span1-1">
									<option value="0" ${xianlu.state==0?"selected":"" }>启用</option>
									<option value="1" ${xianlu.state==1?"selected":"" }>停用</option>
								</select>
							</td>
						</tr>
					</table>
					<table id="" class="table table-bordered">
						...
						<tr>
							<td><textarea name="xianlu.remark" rows="3" cols="50" class="span11">${xianlu.remark}</textarea></td>
						</tr>
					</table>
