...
<body>
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				...
				<form action="${pageContext.request.contextPath}/tuoyundanAction!queryTuoyundanList"" name="form1"  method="post" >
				<s:token name="s_token"></s:token>
					...
					<table class="table table-bordered">
						<tr>
							...
							<input type="text"  name="btime"  value="${btime }"  class="laydate-icon span2"  id="Calendar1"  />
							 &nbsp; 至 &nbsp; 
							<input type="text"  name="etime"  value="${etime }"  class="laydate-icon span2"  id="Calendar2"   /></td>
						...
						<!-- 
						<tr>
							<td align="right" bgcolor="#f1f1f1">中转单号：</td>
							<td><input type="text" name=""  class="span1-1" /></td>
							<td align="right" bgcolor="#f1f1f1">班次：</td>
							<td><input type="text" name=""  class="span1-1" /></td>
							<td  align="right" bgcolor="#f1f1f1">是否审核：</td> 
							<td><input type="text" name=""  class="span1-1" />  </td>
							<td align="right" bgcolor="#f1f1f1">是否中转：</td> 
							<td><input type="text" name=""  class="span1-1" />  </td>
							<td align="right" bgcolor="#f1f1f1">中转完成：</td>
							<td><input type="text" name=""  class="span1-1" /></td>
						</tr>
						<tr>
							
							
							<td align="right" bgcolor="#f1f1f1">是否送货：</td>
							<td><input type="text" name=""  class="span1-1" /></td>
							<td align="right" bgcolor="#f1f1f1">是否退货：</td>
							<td><input type="text" name=""  class="span1-1" /></td>
							<td  align="right" bgcolor="#f1f1f1">是否POS机：</td> 
							<td><input type="text" name=""  class="span1-1" />  </td>
							<td  align="right" bgcolor="#f1f1f1">使用物流卷：</td> 
							<td><input type="text" name=""  class="span1-1" />  </td>
							<td align="right" bgcolor="#f1f1f1">订单号：</td>
							<td ><input type="text" name=""  class="span1-1" /></td>
						</tr>
						 -->
					</table>
					...
					<table class="margin-bottom-20 table  no-border">
						<tr>
							...
							<td class="text-center"><input type="button" value="新建"  onclick="location.href='${pageContext.request.contextPath}/tuoyundanAction!findTuoyundanForModify?modify=save'"  id="modal-9735581" class="btn btn-info btn-small" style="width: 80px;" /></td>
						</tr>
					</table>
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<c:if test="${list.state eq '0' }">
								...
								<a href="${pageContext.request.contextPath}/tuoyundanAction!findTuoyundanForModify?modify=update&tyid=${list.tyid }">修改</a>&nbsp;&nbsp;
							
								<a href="${pageContext.request.contextPath}/tuoyundanAction!deleteTuoyundanByID?tyid=${list.tyid } " onclick="return(confirm('确认要撤销运单吗?'))">撤销</a>
