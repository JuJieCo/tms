...
<body>
	...
	<div class="right" id="mainFrame">
		<div class="right_cont">
			...
			<form name="form" method="post" action="${pageContext.request.contextPath}/wangdianAction!modifyWangdian" onsubmit="return validateForm(this)">
				...
				<div style="width: 1200px; margin: auto">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td>
								<input type="text" id="name" name="wangdian.name" value="${wangdian.name}" class="span2" /> 
								<input name="wangdian.wdid" type="hidden" value="${wangdian.wdid }">
							</td>
							<td width="10%" align="right" bgcolor="#f1f1f1">网点状态：</td>
							<td>
								<select name="wangdian.state" class="span1-1">
									<option value="0" ${wangdian.state==0?"selected":"" }>启用</option>
									<option value="1" ${wangdian.state==1?"selected":"" }>停用</option>
								</select>
							</td>
						</tr>
					</table>
					<table id="" class="table table-bordered">
						...
						<tr>
							<td><textarea name="wangdian.remark" rows="3" cols="50" class="span11">${wangdian.remark}</textarea></td>
						</tr>
					</table>
